...
class CommandData(object):
    ...
    def __init__(self, command_id: str, command: ICommand, name: Optional[str] = None):
        self.command_id: str = command_id
        self.command: ICommand = command
...
class CommandManager(object):
    ...
    def register_command(self, command_id: str, command: ICommand, name: Optional[str] = None):
