...
from ui.utils import (
    create_no_focus_tool_button, add_layout_children,
...
class EditCreationSolutionsView(object):
    ...
    def __init__(self, dialog: QDialog):
        ...
        self.solution_panel_layout = create_column_layout(
        ...
        self.document_relative_path_title = create_row_title(r'Relative Path')
        self.document_relative_path_input = create_no_focus_line_edit()
        self.document_relative_path_row = create_row_layout(
            title=self.document_relative_path_title,
            widget=self.document_relative_path_input
        )

        self.document_encoding_title = create_row_title(r'File Encoding')
        self.document_encoding_input = create_no_focus_line_edit()
        self.document_encoding_row = create_row_layout(
            title=self.document_encoding_title,
            widget=self.document_encoding_input
        )

        self.document_template_name_title = create_row_title(r'Template')
        self.document_template_name_input = create_no_focus_line_edit()
        self.document_template_name_row = create_row_layout(
        ...
        self.document_detail_layout = create_column_layout(
        ...
        self.document_panel_layout = create_column_layout(
        ...
        self.template_panel_layout = create_column_layout(children=[self.template_title, self.template_preview])
