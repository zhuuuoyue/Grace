...
class SwitchEnvironmentDialogView(object):
    ...
    def __init__(self, dialog: QDialog, vm: SwitchEnvironmentDialogViewModel):
        ...
        title_width = 150
        self.software_title = form.create_row_title('Software', width=title_width)
        ...
        self.software_layout = form.create_row_layout(self.software_selector, self.software_title)

        self.current_environment_title = form.create_row_title('Current Environment', width=title_width)
        ...
        self.current_environment_layout = form.create_row_layout(
            self.current_environment_input, self.current_environment_title)

        self.target_environment_title = form.create_row_title('Target Environment', width=title_width)
        ...
        self.target_environment_layout = form.create_row_layout(
